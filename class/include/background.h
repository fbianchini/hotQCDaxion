...
/**
 * @name Masses (in eV) where the sign in the denominator of fp_app switch from +1 to -1 (axions)
 */

//@{

#define _ma_tmp_   0.23993
#define _ma_tmp1_  0.43
#define _ma_tmp11_ 0.4578
#define _ma_tmp2_  0.55575 
#define _ma_tmp3_  0.7196544 
#define _ma_tmp4_  1.56267833 
#define _ma_tmp5_  2.9818853
